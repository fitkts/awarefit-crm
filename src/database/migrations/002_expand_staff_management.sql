...
-- gender 컬럼 추가
ALTER TABLE staff
ADD COLUMN gender TEXT CHECK(gender IN ('남성', '여성'));
...
-- updated_at 컬럼 추가 (SQLite 제한으로 DEFAULT 없이 추가)
ALTER TABLE staff
...
-- 6. 기본 역할 데이터 삽입
INSERT
  OR IGNORE INTO staff_roles (name, permissions, description)
VALUES (
    '관리자',
    '{"member_management":true,"payment_management":true,"staff_management":true,"report_access":true,"system_settings":true}',
    '모든 권한을 가진 관리자'
  ),
  (
    '트레이너',
    '{"member_management":true,"payment_management":false,"staff_management":false,"report_access":true,"system_settings":false}',
    'PT 및 회원 관리 담당'
  ),
  (
    '데스크',
    '{"member_management":true,"payment_management":true,"staff_management":false,"report_access":false,"system_settings":false}',
    '프론트 데스크 담당'
  ),
  (
    '청소',
    '{"member_management":false,"payment_management":false,"staff_management":false,"report_access":false,"system_settings":false}',
    '시설 관리 담당'
  );
