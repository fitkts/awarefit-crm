...
Awarefit CRM은 피트니스 센터의 회원, 직원, 결제를 효율적으로 관리할 수 있는
데스크톱 애플리케이션입니다.
...
- **Database**: SQLite (better-sqlite3) + 🤖 자동복구 시스템
- **Styling**: Tailwind CSS
- **Testing**: Jest + Playwright
- **Build**: Webpack + Electron Builder
- **DevOps**: 완전 자동화된 환경 호환성 관리
...
- ✅ **better-sqlite3 호환성 자동 관리**: NODE_MODULE_VERSION 오류 자동 해결
- ✅ **3단계 자동 복구**: 실패 시 점진적 복구 전략
- ✅ **모듈 캐시 자동 클리어**: Electron 환경 호환성 보장
- ✅ **투명한 로깅**: 모든 복구 과정 실시간 표시
...
- **🔧 better-sqlite3 자동 복구**: `npm run fix-sqlite3`

## 🚨 문제 해결

### **better-sqlite3 NODE_MODULE_VERSION 오류**

이 프로젝트는 완전 자동화된 better-sqlite3 복구 시스템을 내장하고 있습니다:
...
- `docs/better-sqlite3-문제해결-치트시트.md` - 빠른 참조 가이드
...
이 프로젝트는 MIT 라이선스 하에 배포됩니다. 자세한 내용은 `LICENSE` 파일을
참조하세요.
...
- 📧 이슈 등록:
  [GitHub Issues](https://github.com/your-username/awarefit-crm/issues)
- 📖 문서: `docs/` 폴더 참조
